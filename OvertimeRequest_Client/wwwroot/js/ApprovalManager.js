        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    return `<button onclick="ApproveManager('${row["overtimeId"]}',  '${row["dateOvertime"]}', '${row["dateRequest"]}')" class="btn btn-success fas fa-fw fa-thumbs-up"></button>
                            <button onclick="DeclineManager('${row["overtimeId"]}',  '${row["dateOvertime"]}', '${row["dateRequest"]}')" class="btn btn-danger fas fa-fw fa-thumbs-down"></button>`
                },
            },
        ],
    });
...
function ApproveManager(id, overtimeDate, createDate) {
...
function DeclineManager(id, overtimeDate, createDate) {
